 ...
 *   ## Example elements
 *     * Level
 *     * Videoscale, audioconvert, videoconvert, audioresample in
 *     certain modes.
 *
 * *
 *     ## Modifications in-place - input buffer and output buffer are the
 *     same thing.
 ...
 *   ## Example elements
 *     * Volume
 *     * Audioconvert in certain modes (signed/unsigned
 *     conversion)
 *     * videoconvert in certain modes (endianness
 *     swapping)
 *
 * *
