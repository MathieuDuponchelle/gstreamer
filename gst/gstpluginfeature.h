...
typedef struct _GstPluginFeaturePrivate GstPluginFeaturePrivate;
...
void            gst_plugin_feature_set_plugin           (GstPluginFeature *feature, GstPlugin *plugin);
...
void            gst_plugin_feature_set_loaded           (GstPluginFeature *feature, gboolean loaded);
gboolean        gst_plugin_feature_get_loaded           (GstPluginFeature *feature);
